 ...
 */
AlipayAPI.request = function (ali_params, method, biz_content) {
    ...
    try {
        alipayRequest.rsaPrivateKey = path.join('config', '', ali_params.private_key_name);
        alipayRequest.alipayrsaPublicKey = path.join('config', '', ali_params.public_key_name);
    } catch (e) {
    ...
    //------------------SET sendParam-------------------
    alipayRequest.setParam('app_id', ali_params.appid);    //'2017021405667105'
